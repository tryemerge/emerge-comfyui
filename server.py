...
# === START WEBSOCKET CHANGES ===
            # Auto-generate new ID and send to client
            sid = uuid.uuid4().hex
            self.sockets[sid] = ws
            self.sockets_metadata[sid] = {"feature_flags": {}}  # Upstream addition
                        ...
                        try:
                            ...
                            # === KEEP: Our prompt submission via WebSocket ===
                                ...
                                if 'prompt' in prompt_data:
                                    ...
                                    valid = await execution.validate_prompt(prompt_data['prompt_id'], prompt, None)
                                    if valid[0]:
